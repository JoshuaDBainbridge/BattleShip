...
class DrawCanvas extends Canvas
{
    ...
    private void initImages() throws IOException
    {
        ...
        menuBuff = ImageIO.read(new File("background.png"));

        winBuff = ImageIO.read(new File("win.png"));
        loseBuff = ImageIO.read(new File("lose.png"));

        zaneWins = ImageIO.read(new File("player1win.png"));
        euanWins = ImageIO.read(new File("player2win.png"));
    ...
    public void setStreams(DataInputStream i, DataOutputStream o, int ii)
    {
        in = i;
        out = o;
        turn = ii;
    ...
    public void menuState()
    {
        ...
        drawGraphics.drawString("Operating Systems Project", 700, 15);
    }
    ...
    public void reactToClick() throws IOException, ClassNotFoundException {
        if(turn != -1)
        {
            ...
            if(bsp.shipsRemaining()) {
                ...
                // if the opponent told me that it was a hit,
